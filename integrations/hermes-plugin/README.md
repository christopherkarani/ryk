...
3. Confirm the tool proceeds with **no** approval prompt.
4. Confirm an explicit policy deny still blocks.
5. Export `CI=1` and confirm the same residual `ask` becomes a hard block without a prompt.
