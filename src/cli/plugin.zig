...
const plugin_hermes_install = @import("plugin_hermes_install.zig");

pub const hermesUserPluginRoot = plugin_hermes_install.hermesUserPluginRoot;
pub const hermesConfigPath = plugin_hermes_install.hermesConfigPath;
pub const runHermesEnable = plugin_hermes_install.runHermesEnable;
pub const hermesUserManifestNameIsRyk = plugin_hermes_install.hermesUserManifestNameIsRyk;
pub const hermesManifestDeclaresNameRyk = plugin_hermes_install.hermesManifestDeclaresNameRyk;
pub const normalizeHermesManifestNameToRyk = plugin_hermes_install.normalizeHermesManifestNameToRyk;
pub const prepareHermesUnattendedInstall = plugin_hermes_install.prepareHermesUnattendedInstall;

const hermesManagedDestination = plugin_hermes_install.hermesManagedDestination;
const installHermesBundleAtomically = plugin_hermes_install.installHermesBundleAtomically;
const writeHermesEnableHelper = plugin_hermes_install.writeHermesEnableHelper;
const writeHermesFailClosedStance = plugin_hermes_install.writeHermesFailClosedStance;
const runHermesDisableLegacy = plugin_hermes_install.runHermesDisableLegacy;
